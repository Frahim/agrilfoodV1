...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 5820)), "E:\\agril backup\\frontend\\agrilfoodV1\\app\\product\\[slug]\\page.tsx"],
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 2104)), "E:\\agril backup\\frontend\\agrilfoodV1\\app\\layout.tsx"],
          
        }
      ]
      }.children;
    const pages = ["E:\\agril backup\\frontend\\agrilfoodV1\\app\\product\\[slug]\\page.tsx"];
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 1446));
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 3300))
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ ProductCarosul)
});
...
;// CONCATENATED MODULE: ./lib/getProductbySlug.tsx
async function getBrandBySlug(slug) {
    const res = await fetch(`https://admin.agrilfoods.com/api/products/${slug}`, {
        next: {
            revalidate: 60
        }
    });
...
var image_gallery = __webpack_require__(7158);
...
var css_image_gallery = __webpack_require__(8945);
;// CONCATENATED MODULE: ./components/ProductCarosul.tsx
...
const ProductCarousel = ({ params  })=>{
    const [product, setProduct] = (0,react_.useState)(null);
    (0,react_.useEffect)(()=>{
        const fetchProduct = async ()=>{
            try {
                const productData = await getBrandBySlug(params.slug);
    ...
    if (productGalleryImages.length === 0) {
        return /*#__PURE__*/ jsx_runtime_.jsx(jsx_runtime_.Fragment, {
            children: /*#__PURE__*/ jsx_runtime_.jsx((image_gallery_default()), {
                items: [
                    {
...
/* harmony default export */ const ProductCarosul = (ProductCarousel);
...
var carousel_min = __webpack_require__(5924);
// EXTERNAL MODULE: ./components/Navbar.tsx + 1 modules
var Navbar = __webpack_require__(5768);
;// CONCATENATED MODULE: ./lib/getProduct.tsx
async function getProduct(id) {
    const res = await fetch(`https://admin.agrilfoods.com/api/products/${id}`, {
        next: {
            revalidate: 60
        }
    });
...
// EXTERNAL MODULE: ./components/ProductCarosul.tsx
var ProductCarosul = __webpack_require__(1431);
var ProductCarosul_default = /*#__PURE__*/__webpack_require__.n(ProductCarosul);
;// CONCATENATED MODULE: ./app/product/[slug]/page.tsx
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            ...
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                className: "wrapper sectionPadding",
                    ...
                    children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                        ...
                        children: [
                            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                ...
                                children: /*#__PURE__*/ jsx_runtime_.jsx((ProductCarosul_default()), {
                                    params: {
                                        slug: slug
                                    }
                                })
                            ...
                            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                        className: "productTypeDescription",
                                        children: /*#__PURE__*/ jsx_runtime_.jsx("div", {
...
module.exports = createProxy("E:\\agril backup\\frontend\\agrilfoodV1\\components\\ProductCarosul.tsx");
...
var __webpack_exports__ = __webpack_require__.X(0, [637,520,292,837], () => (__webpack_exec__(6503)));
